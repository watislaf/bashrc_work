...
function bash__gTools__ {
  ...
  function BASH_GTOOLS__PRINT__SECTION {
	  ...
	  echo -e z"${BASH_GTOOLS__START_COLOR}||${BASH_GTOOLS__MIDDLE_COLOR}"
	  ...
	  echo -e  "${BASH_GTOOLS__START_COLOR}---------------${BASH_GTOOLS__MIDDLE_COLOR} ${1} ${BASH_GTOOLS__START_COLOR}---------------"  | head -c 70  ;	  echo ""  ;	  echo -en "${BASH_GTOOLS__DEFAULT_END_COLOR}"
  }
  ...
  function BASH_GTOOLS__PRINT__COMMAND { 
	...
	function BASH_GTOOLS__ADDITIONAL_PRINT__COMMAND {	
	 BASH_GTOOLS__START_COLOR_UNDER="\e[4;${BASH_GTOOLS__VAR_INCREMENT_EACH_TIME_PRINT_SECTION_IS_CALLED}m"
	  echo -e  "${BASH_GTOOLS__START_COLOR_UNDER}           ${1}"  | head -c 50  ;	  echo ""  ;	  echo -en "${BASH_GTOOLS__DEFAULT_END_COLOR}" 
		echo -e "${BASH_GTOOLS__DEFAULT_END_COLOR} $2$ {BASH_GTOOLS__DEFAULT_END_COLOR}"
		echo ""
